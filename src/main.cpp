...
static const unsigned int timeGenesisBlock = 1412737893;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "'7th Heaven' star Stephen Collins exposed himself to young girls, report says";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x8558dfa061cf8d06cea90c30c089e97195c1502b6fa7d2eef174518d227dca87"));
